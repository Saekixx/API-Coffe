...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(TokenProviderPort tokenProviderPort, UserDetailsService userDetailsService) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (StringUtils.hasText(token) && tokenProviderPort.validarToken(token)) {
